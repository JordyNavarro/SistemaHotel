...
namespace SistemaHotel.Server.Test.Controllers
{
    ...
    public class PisoControllerTest
    {
        ...
        private IPisoRepositorio _pisoRepositorio;
        private PisoController _controller;
        ...
        public void Init()
        {
            ...
            _pisoRepositorio = new PisoRepositorio(new Models.DbhotelBlazorContext());
            _controller = new PisoController(_pisoRepositorio, _mapper);
        }
        ...
        {
            ObjectResult result = (ObjectResult)await _controller.Guardar(new Shared.PisoDTO());
            Assert.AreEqual(result.StatusCode, StatusCodes.Status200OK);
        }
        ...
        {
            ObjectResult result = (ObjectResult)await _controller.Editar(new Shared.PisoDTO());
            Assert.AreEqual(result.StatusCode , StatusCodes.Status200OK);
        }
